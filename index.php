...
<body class="anystretch">
	<header>
		<h1><img id="branding" src="images/croydoncreatives.png" alt="croydoncreatives" title="The Croydon Creatives, a bunch of web workers meeting for a pint and a chat. Join us?" width="" height="" /></h1>
		<nav>
			<ul class="mainnav">
...
<p>If you're interested, why don't you come down & join us one evening?</p>
	...
	<section id="jointhelist">
		...
		<div class="mc-field-group">
		<label for="mce-FNAME">Name <strong class="note-required">*</strong>
		</label>
